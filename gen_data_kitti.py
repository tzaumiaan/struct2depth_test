...
f_tr = open(os.path.join(OUTPUT_DIR, 'train.txt'), 'w')
    ...
    for d2 in glob.glob(d + '*/'):
        ...
        for subfolder in ['image_02/data', 'image_03/data']:
            ...
            for i in range(SEQ_LENGTH, len(files)+1, STEPSIZE):
                ...
                dummy_seg = big_img * 0.0
                cv2.imwrite(OUTPUT_DIR + seqname + '/' + imgnum + '-fseg.png', dummy_seg)
                f_tr.write('{} {}\n'.format(seqname, imgnum))
